fact_spends.xlsx  - Contains Dataset of customer id and their spending on different categories , payment type and Month (fact_spends.csv exceeds more than 25 mb and had to convert to xlsx).
